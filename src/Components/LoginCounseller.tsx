      ...
      <div className="w-full max-w-sm p-6 border border-gray-200 rounded-lg shadow-lg bg-white">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-gray-800">
            <span className="text-blue-600">Counseller</span> Login
          </h1>
...
<div className="flex flex-row justify-between ">
          ...
          <button onClick={()=>navigate('/Login-Sale')} className="w-60 bg-blue-600 text-white py-2 rounded-lg font-medium hover:bg-blue-700 transition disabled:opacity-60"> <span className="p-1 ">Login as a Sales person</span></button>
</div>
        </form>
      </div>
    </div>
...
export default LoginCounseller;
